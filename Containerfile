...
RUN dnf --nodocs -y --best --allowerasing install qemu-user-static docker ccache vim-enhanced mandoc grub2-tools-minimal --excludepkgs cross-gcc-common-10.2.1-3.fc34.2.noarch,'gcc*-linux-gnu-10.2.1-3.fc34.2.x86_64'
